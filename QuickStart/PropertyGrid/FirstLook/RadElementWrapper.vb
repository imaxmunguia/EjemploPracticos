...
#Region "Properties"
        ...
        <Description("Gets or sets the text displayed in the control.")> _
        <Category("Text")> _
        <DefaultValue("RadPropertyGrid")> _
        <Browsable(True)> _
        ...
        <Description("Gets or sets the size of the text displayed in the control.")> _
        <Category("Text")> _
        <DefaultValue(12)> _
        <Browsable(True)> _
        ...
        <Description("Gets or sets the width of the control border.")> _
        <Category("Border")> _
        <DefaultValue(2)> _
        <Browsable(True)> _
