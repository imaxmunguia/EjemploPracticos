...
Namespace Telerik.Examples.WinControls.GridView.CustomPainting
    Partial Public Class Form1
        ...
        Private fills As Color() = New Color() {Color.FromArgb(153, 255, 0), Color.FromArgb(255, 204, 204), Color.FromArgb(0, 255, 255)}

        Private borders As Color() = New Color() {Color.Green, Color.Red, Color.Blue}
        ...
        Protected Overrides Sub OnLoad(ByVal e As EventArgs)
            ...
            AddHandler Me.radGridView1.CreateRowInfo, AddressOf radGridView1_CreateRowInfo
            AddHandler Me.radGridView1.RowPaint, AddressOf radGridView1_RowPaint
            ...
            Dim months As String() = New String() {"Jan", "Feb", "Mar"}
        ...
        Protected Overrides Sub OnSizeChanged(ByVal e As EventArgs)
            ...
            If Me.radGridView1 IsNot Nothing Then
                Dim width As Integer = Me.ClientSize.Width
                Dim height As Integer = Me.ClientSize.Height
                Me.radGridView1.Location = New Point((width - radGridView1.Size.Width) \ 2, Me.radGridView1.Location.Y)
            End If
        End Sub
        ...
        Private Sub radGridView1_RowPaint(ByVal sender As Object, ByVal e As GridViewRowPaintEventArgs)
            If TypeOf e.Row Is GridDataRowElement Then
                Dim rowElement As GridDataRowElement = DirectCast(e.Row, GridDataRowElement)
                Dim startIndex As Integer = CInt(e.Row.RowInfo.Cells("StartCell").Value)
                Dim endIndex As Integer = CInt(e.Row.RowInfo.Cells("EndCell").Value)
                ...
                If startCell IsNot Nothing OrElse endCell IsNot Nothing Then
                    ...
                    Dim randomColor As Integer = CInt(e.Row.RowInfo.Cells("Color").Value)
