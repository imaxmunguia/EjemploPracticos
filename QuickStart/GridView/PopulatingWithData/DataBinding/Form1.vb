...
Namespace Telerik.Examples.WinControls.GridView.PopulatingWithData.DataBinding
	Partial Public Class Form1
		...
		Private list2 As BindingList(Of StudentObject) = New BindingList(Of StudentObject)()
		...
		Public Class StudentObject
			...
			Private age_Renamed As Nullable(Of Integer)

			Public Sub New(ByVal iFname As String, ByVal iLname As String, ByVal iHeight As Single, ByVal iWeight As Single, ByVal iAge As Nullable(Of Integer))
			...
			Public Property Age() As Nullable(Of Integer)
				...
				Set(ByVal value As Nullable(Of Integer))
					If Not Me.age_Renamed.Equals(value) Then
		...
		Private Sub radRadio_ToggleStateChanged(ByVal sender As Object, ByVal args As StateChangedEventArgs) Handles radRadioArrLst.ToggleStateChanged, radRadioSubObj.ToggleStateChanged, radRadioObjects.ToggleStateChanged, radRadioDataReader.ToggleStateChanged
			Me.radGridView1.MasterTemplate.Columns.Clear()
