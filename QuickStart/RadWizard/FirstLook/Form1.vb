...
Namespace Telerik.Examples.WinControls.RadWizard.FirstLook
	Partial Class Form1
		...
		Protected Overrides Sub OnLoad(ByVal e As EventArgs)
			...
			Me.panel0.Location = New Point((parent.Width - Me.panel0.Width) /2, (parent.Height - Me.panel0.Height)/2)			
		...
		Private Sub radButtonWelcomeBackColor_Click(ByVal sender As Object, ByVal e As EventArgs)
			...
			If radColorDialog.ShowDialog() = System.Windows.Forms.DialogResult.OK Then
		...
		Private Sub radWizard1_Next(ByVal sender As Object, ByVal e As WizardCancelEventArgs)
			If not Me.radWizard1.SelectedPage.Equals( Me.wizardPage3 ) Then
				Return
			End If
			e.Cancel = True
		...
		Private Sub radWizard1_Previous(ByVal sender As Object, ByVal e As WizardCancelEventArgs)
			If not Me.radWizard1.SelectedPage.Equals(Me.radWizard1.CompletionPage) AndAlso not Me.radWizard1.SelectedPage.Equals(Me.wizardPage4) Then
				Return
			End If
			e.Cancel = True
		...
		Private Sub radWizard1_SelectedPageChanged(ByVal sender As Object, ByVal e As SelectedPageChangedEventArgs)
			If e.SelectedPage.Equals(Me.wizardPage4) Then
            ...
            ElseIf e.SelectedPage.Equals(Me.wizardPage2) Or e.PreviousPage.Equals(Me.wizardPage2) Then
                Me.ResetGridData()
                Me.ResetButtonStates()
            End If
		End Sub
