    ...
    public partial class Form1 : ExamplesForm
    {
        ...
        protected override void OnSizeChanged(EventArgs e)
        {
            ...
            if (this.radPanel2 != null)
            {
                ...
                height -= this.radPanel1.Height + this.radPanel2.Height;
                height /= 2;

                this.radPanel1.Location = new Point((width - this.radPanel1.Width) / 2, height);
                this.radPanel2.Location = new Point((width - this.radPanel2.Width) / 2, height + this.radPanel1.Height);
            }
        }
