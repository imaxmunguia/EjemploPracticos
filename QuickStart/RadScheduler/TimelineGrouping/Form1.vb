...
Namespace Telerik.Examples.WinControls.RadScheduler.TimelineGrouping
	Partial Public Class Form1
		...
		Public Sub New()
			...
			Me.radScheduler1.GetTimelineView().StartDate = dtStart
			Me.radScheduler1.GetTimelineView().RangeStartDate = dtStart
			Me.radScheduler1.GetTimelineView().RangeEndDate = dtStart.AddDays(6)
		...
		Private Sub FillAppointments()
			...
			appointment.ResourceId = Me.radScheduler1.Resources(0).Id
			...
			appointment.ResourceIds.Add(Me.radScheduler1.Resources(1).Id)
			Me.radScheduler1.Appointments.Add(appointment)
			...
			appointment.StatusId = CInt(Fix(AppointmentStatus.Tentative))
			Me.radScheduler1.Appointments.Add(appointment)
			appointment.ResourceIds.Add(Me.radScheduler1.Resources(0).Id)
		...
		Private Sub FillResources()
			Dim resource As New Resource(Guid.NewGuid(), "Room 701")
