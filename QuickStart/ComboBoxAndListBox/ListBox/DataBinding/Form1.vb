...
Namespace Telerik.Examples.WinControls.ComboBoxAndListBox.ListBox.DataBinding
	Partial Public Class Form1
		...
		Private Sub OnRadioOptions_ToggleStateChanged(ByVal sender As Object, ByVal args As StateChangedEventArgs) Handles radRadioArray.ToggleStateChanged, radRadioDB.ToggleStateChanged, radRadioDataTable.ToggleStateChanged, radRadioUnbound.ToggleStateChanged
