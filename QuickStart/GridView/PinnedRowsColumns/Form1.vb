...
Namespace Telerik.Examples.WinControls.GridView.PinnedRowsColumns
	Partial Public Class Form1
		...
		Private Sub radComboBoxColumns_SelectedIndexChanged(ByVal sender As Object, ByVal e As Telerik.WinControls.UI.Data.PositionChangedEventArgs) Handles radComboBoxColumns.SelectedIndexChanged
		...
		Private Sub radRadioButtonColumnPinnedNone_ToggleStateChanged(ByVal sender As Object, ByVal args As Telerik.WinControls.UI.StateChangedEventArgs) Handles radRadioButtonColumnPinnedNone.ToggleStateChanged
			Me.SetColumnPinPosition(PinnedColumnPosition.None)
		End Sub

		Private Sub radRadioButtonColumnPinnedLeft_ToggleStateChanged(ByVal sender As Object, ByVal args As Telerik.WinControls.UI.StateChangedEventArgs) Handles radRadioButtonColumnPinnedLeft.ToggleStateChanged
			Me.SetColumnPinPosition(PinnedColumnPosition.Left)
		End Sub

		Private Sub radRadioButtonColumnPinnedRight_ToggleStateChanged(ByVal sender As Object, ByVal args As Telerik.WinControls.UI.StateChangedEventArgs) Handles radRadioButtonColumnPinnedRight.ToggleStateChanged
			Me.SetColumnPinPosition(PinnedColumnPosition.Right)
		End Sub

		Private Sub radComboBoxSystemRows_SelectedIndexChanged(ByVal sender As Object, ByVal e As Telerik.WinControls.UI.Data.PositionChangedEventArgs) Handles radComboBoxSystemRows.SelectedIndexChanged
		...
		Private Sub radComboBoxRowPinPosition_SelectedIndexChanged(ByVal sender As Object, ByVal e As Telerik.WinControls.UI.Data.PositionChangedEventArgs) Handles radComboBoxRowPinPosition.SelectedIndexChanged
		...
		Private Sub radComboBoxSystemRowPosition_SelectedIndexChanged(ByVal sender As Object, ByVal e As Telerik.WinControls.UI.Data.PositionChangedEventArgs) Handles radComboBoxSystemRowPosition.SelectedIndexChanged
