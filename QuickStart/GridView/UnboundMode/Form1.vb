...
Namespace Telerik.Examples.WinControls.GridView.UnboundMode
	Partial Public Class Form1
		...
		Private bitmaps As List(Of Bitmap) = New List(Of Bitmap)()
		...
		Private Sub radGridView1_CellBeginEdit(ByVal sender As Object, ByVal e As GridViewCellCancelEventArgs)
			If Me.radGridView1.ActiveEditor IsNot Nothing Then
                If TypeOf Me.radGridView1.ActiveEditor Is RadDateTimeEditor Then
		...
		Private Sub btnAddColumn_Click(ByVal sender As Object, ByVal e As EventArgs) Handles radBtnAddCol.Click
			AppendNewColumn(Me.radComboBox1.SelectedItem.Text, True)
			Me.LoadColumnsComboBox()
		End Sub

		Private Sub btnRemoveColumn_Click(ByVal sender As Object, ByVal e As EventArgs) Handles radBtnRmCol.Click
		...
		Private Sub btnAddRow_Click(ByVal sender As Object, ByVal e As EventArgs) Handles radBtnAddRow.Click
			Me.radGridView1.Rows.Add(Nothing, Nothing)
		End Sub

		Private Sub btnRemoveSelectedRows_Click(ByVal sender As Object, ByVal e As EventArgs) Handles radBtnRmRows.Click
		...
		Private Sub radCheckBox1_ToggleStateChanged(ByVal sender As Object, ByVal args As StateChangedEventArgs) Handles radCheckShowNewRow.ToggleStateChanged
			Me.radGridView1.MasterTemplate.AllowAddNewRow = args.ToggleState = ToggleState.On
		End Sub

		Private Sub radGridView1_RowsChanging(ByVal sender As Object, ByVal e As GridViewCollectionChangingEventArgs) Handles radGridView1.RowsChanging
			Console.WriteLine("Rows changing action:{0}", e.Action)
		End Sub

		Private Sub radGridView1_RowsChanged(ByVal sender As Object, ByVal e As GridViewCollectionChangedEventArgs) Handles radGridView1.RowsChanged
