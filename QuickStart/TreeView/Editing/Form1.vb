...
Namespace Telerik.Examples.WinControls.TreeView.Editing
	...
	Partial Class Form1
		...
		Private Sub LoadData()
			...
			table.Rows.Add(4, 2, "Fore color", New PropertyHelper(radPanel1.PanelElement, "ForeColor"))
		...
		Protected Overrides Sub OnSizeChanged(ByVal e As EventArgs)
			...
			If Me.radPanel4 IsNot Nothing Then
				Dim width As Integer = Me.ClientSize.Width
				Dim height As Integer = Me.ClientSize.Height

				height -= Me.radPanel4.Height + Me.radPanel3.Height
				height /= 2

				Me.radPanel3.Location = New Point((width - Me.radPanel4.Width) / 2, height)
				Me.radPanel4.Location = New Point((width - Me.radPanel4.Width) / 2, height + Me.radPanel3.Height)
			End If
		End Sub
		...
		Private Sub radTreeView1_ValueChanging(ByVal sender As Object, ByVal e As TreeNodeValueChangingEventArgs)
			...
			If helper.ValueType Is GetType(System.Single) Then
		...
		Private Sub radTreeView1_EditorRequired(ByVal sender As Object, ByVal e As TreeNodeEditorRequiredEventArgs)
			...
			If helper IsNot Nothing Then
				If helper.ValueType Is GetType(System.Single) OrElse helper.ValueType Is GetType(ElementShape) Then
