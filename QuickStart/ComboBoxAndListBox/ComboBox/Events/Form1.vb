...
Namespace Telerik.Examples.WinControls.ComboBoxAndListBox.ComboBox.Events
	Partial Public Class Form1
		...
		Private Sub chBoxCaseSensitive_CheckedChanged(ByVal sender As Object, ByVal args As Telerik.WinControls.UI.StateChangedEventArgs) Handles radCheckCase.ToggleStateChanged
