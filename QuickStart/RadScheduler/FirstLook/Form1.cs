...
namespace Telerik.Examples.WinControls.RadScheduler.FirstLook
{
    public partial class Form1 : Telerik.WinControls.UI.RadForm
    {
        ...
        public Form1()
        {
            ...
            this.cmbTheme.SelectedIndexChanged += new Telerik.WinControls.UI.Data.PositionChangedEventHandler(cmbTheme_SelectedIndexChanged);
        ...
        void cmbTheme_SelectedIndexChanged(object sender, Telerik.WinControls.UI.Data.PositionChangedEventArgs e)
        {
            string selectedThemeName = this.cmbTheme.Text;

            ThemeResolutionService.ApplyThemeToControlTree(this, selectedThemeName);
        }
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            List<Theme> themes = ThemeResolutionService.GetAvailableThemes(this.radSchedulerDemo);

            foreach (Theme theme in themes)
            {
                if (theme.Name == "Desert" || theme.Name == "ControlDefault")
                {
                    this.cmbTheme.Items.Add(theme.Name);
                }
            }
            this.cmbTheme.Text = "ControlDefault";
