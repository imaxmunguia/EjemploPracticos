...
Namespace Telerik.Examples.WinControls.ComboBoxAndListBox.ComboBox.Resizing
	Partial Public Class Form1
		...
		Private Sub OnRadioSizingMode_ToggleStateChanged(ByVal sender As Object, ByVal args As Telerik.WinControls.UI.StateChangedEventArgs) Handles radRadioUpDown.ToggleStateChanged, radRadioBottomUpDown.ToggleStateChanged, radRadioRightBottom.ToggleStateChanged, radRadioNone.ToggleStateChanged
