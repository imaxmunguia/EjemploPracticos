...
Namespace Telerik.Examples.WinControls.TreeView.CheckBoxes
	Partial Class Form1
		...
		Private Sub rcbTriState_ToggleStateChanged(ByVal sender As Object, ByVal args As StateChangedEventArgs) handles rcbTriState.ToggleStateChanged 
			Me.radTreeView1.TriStateMode = Me.rcbTriState.IsChecked
		End Sub

		Private Sub rrbShowCheckBox_ToggleStateChanged(ByVal sender As Object, ByVal args As StateChangedEventArgs) handles rrbShowCheckBox.ToggleStateChanged 
			Me.SetSelectedNodeNodeCheckType(CheckType.CheckBox)
		End Sub

		Private Sub rbbShowRadioButton_ToggleStateChanged(ByVal sender As Object, ByVal args As StateChangedEventArgs) handles rrbShowRadioButton.ToggleStateChanged 
			Me.SetSelectedNodeNodeCheckType(CheckType.RadioButton)
		End Sub

		Private Sub rrbNone_ToggleStateChanged(ByVal sender As Object, ByVal args As StateChangedEventArgs) handles rrbNone.ToggleStateChanged 
