...
Namespace Telerik.Examples.WinControls.RadScheduler.Reminder
	Partial Public Class Form1
		...
		Private Sub FillAppointments()
			...
			Dim dtStart As DateTime = DateTime.Now.AddMinutes(-13)
		...
		Private Sub radRadioButtonCustom_ToggleStateChanged(ByVal sender As Object, ByVal args As StateChangedEventArgs) Handles radRadioButtonCustom.ToggleStateChanged
		...
		Private Sub radRadioButtonDefault_ToggleStateChanged(ByVal sender As Object, ByVal args As StateChangedEventArgs) Handles radRadioButtonDefault.ToggleStateChanged
			If args.ToggleState = Telerik.WinControls.Enumerations.ToggleState.On Then
