...
Namespace Telerik.Examples.WinControls.Docking.CommandManager
	Partial Public Class Form1
		...
		Private Sub InitializeComponent()
			...
			Me.documentWindow4.Size = New System.Drawing.Size(337, 573)
			...
			Me.documentWindow3.Size = New System.Drawing.Size(816, 367)
			...
			Me.documentWindow2.Size = New System.Drawing.Size(816, 367)
			...
			Me.documentWindow1.Size = New System.Drawing.Size(816, 367)
			...
			' enableManager
			' 
			Me.enableManager.Anchor = System.Windows.Forms.AnchorStyles.Top
			Me.enableManager.AutoSize = True
			Me.enableManager.ForeColor = System.Drawing.Color.FromArgb((CInt(Fix((CByte(5))))), (CInt(Fix((CByte(5))))), (CInt(Fix((CByte(5))))))
			Me.enableManager.Location = New System.Drawing.Point(10, 37)
			Me.enableManager.Name = "enableManager"
			' 
			' 
			' 
			Me.enableManager.RootElement.ForeColor = System.Drawing.Color.FromArgb((CInt(Fix((CByte(5))))), (CInt(Fix((CByte(5))))), (CInt(Fix((CByte(5))))))
			Me.enableManager.Size = New System.Drawing.Size(156, 14)
...
'			Me.enableManager.ToggleStateChanged += New Telerik.WinControls.UI.StateChangedEventHandler(Me.enableManager_ToggleStateChanged);
			' 
			' commandList
			' 
			Me.commandList.Anchor = System.Windows.Forms.AnchorStyles.Top
			Me.commandList.DropDownStyle = Telerik.WinControls.RadDropDownStyle.DropDownList
			Me.commandList.ForeColor = System.Drawing.Color.Black
			Me.commandList.Location = New System.Drawing.Point(13, 23)
			...
			Me.commandList.RootElement.ForeColor = System.Drawing.Color.Black
			Me.commandList.Size = New System.Drawing.Size(154, 20)
			...
			Me.radGroupBox1.Location = New System.Drawing.Point(10, 57)
			...
			Me.radGroupBox1.Size = New System.Drawing.Size(180, 83)
			Me.radGroupBox1.TabIndex = 4
			Me.radGroupBox1.Text = "Available Commands"
			' 
			' executeCommand
			' 
			Me.executeCommand.Location = New System.Drawing.Point(92, 49)
			Me.executeCommand.Name = "executeCommand"
			Me.executeCommand.Size = New System.Drawing.Size(75, 23)
			Me.executeCommand.TabIndex = 4
			Me.executeCommand.Text = "Execute"
'			Me.executeCommand.Click += New System.EventHandler(Me.executeCommand_Click);
			' 
			' Form1
			' 
		...
		Private WithEvents enableManager As Telerik.WinControls.UI.RadCheckBox
		Private commandList As Telerik.WinControls.UI.RadDropDownList
		Private radGroupBox1 As Telerik.WinControls.UI.RadGroupBox
		Private WithEvents executeCommand As Telerik.WinControls.UI.RadButton
	End Class
End Namespace
