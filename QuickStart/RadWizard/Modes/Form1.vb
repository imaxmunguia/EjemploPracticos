...
Namespace Telerik.Examples.WinControls.RadWizard.Modes
	Partial Class Form1
		...
		Private Sub radWizard1_SelectedPageChanged(ByVal sender As Object, ByVal e As SelectedPageChangedEventArgs)
			...
			If e.SelectedPage.Equals( Me.wizardPage1) AndAlso (Not Me.deviceFound) Then
				...
				Me.deviceFound = True
			ElseIf e.SelectedPage.Equals( Me.wizardPage2) AndAlso (Not Me.installationCompleted) Then
				Me.radWizard1.NextButton.Text = "Install"
			ElseIf e.SelectedPage.Equals( Me.wizardPage3 ) Then
		...
		Private Sub radWizard1_Next(ByVal sender As Object, ByVal e As WizardCancelEventArgs)
			If Me.radWizard1.SelectedPage.Equals(  Me.wizardPage2) AndAlso (Not Me.installationCompleted) Then
		...
		Private Sub timer_Tick(ByVal sender As Object, ByVal e As EventArgs)
			Me.timerSearch.Stop()
			Me.radWaitingBarSearch.EndWaiting()
