...
Namespace Telerik.Examples.WinControls.Chart.MultilineLabels
	Partial Public Class Form1
		...
		Private Sub InitializeComponent()
			...
			' radChart1
			' 
			Me.radChart1.Appearance.Border.Color = Global.System.Drawing.Color.FromArgb((CInt(Fix((CByte(209))))), (CInt(Fix((CByte(197))))), (CInt(Fix((CByte(175))))))
			Me.radChart1.Appearance.Corners = corners1
			Me.radChart1.Appearance.FillStyle.MainColor = Global.System.Drawing.Color.FromArgb((CInt(Fix((CByte(235))))), (CInt(Fix((CByte(249))))), (CInt(Fix((CByte(213))))))
			...
			Me.radChart1.ChartTitle.TextBlock.Appearance.TextProperties.Color = Global.System.Drawing.Color.FromArgb((CInt(Fix((CByte(119))))), (CInt(Fix((CByte(179))))), (CInt(Fix((CByte(60))))))
			Me.radChart1.ChartTitle.TextBlock.Text = "Multiline" & Constants.vbLf & "Labels"
			Me.radChart1.DataGroupColumn = Nothing
			Me.radChart1.DefaultType = Global.Telerik.Charting.ChartSeriesType.SplineArea
			Me.radChart1.Legend.Appearance.Border.Color = Global.System.Drawing.Color.FromArgb((CInt(Fix((CByte(225))))), (CInt(Fix((CByte(217))))), (CInt(Fix((CByte(201))))))
			...
			Me.radChart1.Legend.Appearance.ItemTextAppearance.TextProperties.Color = Global.System.Drawing.Color.FromArgb((CInt(Fix((CByte(157))))), (CInt(Fix((CByte(126))))), (CInt(Fix((CByte(97))))))
			...
			Me.radChart1.PlotArea.Appearance.Border.Color = Global.System.Drawing.Color.FromArgb((CInt(Fix((CByte(225))))), (CInt(Fix((CByte(217))))), (CInt(Fix((CByte(201))))))
			Me.radChart1.PlotArea.Appearance.Corners = corners11
			unit1.Type = Global.Telerik.Charting.Styles.UnitType.Percentage
			unit1.Value = 24F
			unit2.Type = Global.Telerik.Charting.Styles.UnitType.Percentage
			unit2.Value = 22F
			unit3.Type = Global.Telerik.Charting.Styles.UnitType.Percentage
			unit3.Value = 12F
			unit4.Type = Global.Telerik.Charting.Styles.UnitType.Percentage
			unit4.Value = 10F
			Me.radChart1.PlotArea.Appearance.Dimensions.Margins = New Global.Telerik.Charting.Styles.ChartMargins(unit1, unit2, unit3, unit4)
			...
			Me.radChart1.PlotArea.XAxis.Appearance.Color = Global.System.Drawing.Color.FromArgb((CInt(Fix((CByte(225))))), (CInt(Fix((CByte(217))))), (CInt(Fix((CByte(201))))))
			Me.radChart1.PlotArea.XAxis.Appearance.LabelAppearance.Corners = corners13
			Me.radChart1.PlotArea.XAxis.Appearance.MajorGridLines.Color = Global.System.Drawing.Color.FromArgb((CInt(Fix((CByte(225))))), (CInt(Fix((CByte(217))))), (CInt(Fix((CByte(201))))))
			Me.radChart1.PlotArea.XAxis.Appearance.MajorTick.Color = Global.System.Drawing.Color.FromArgb((CInt(Fix((CByte(225))))), (CInt(Fix((CByte(217))))), (CInt(Fix((CByte(201))))))
			Me.radChart1.PlotArea.XAxis.Appearance.TextAppearance.Corners = corners14
			Me.radChart1.PlotArea.XAxis.Appearance.TextAppearance.TextProperties.Color = Global.System.Drawing.Color.FromArgb((CInt(Fix((CByte(112))))), (CInt(Fix((CByte(93))))), (CInt(Fix((CByte(56))))))
			...
			Me.radChart1.PlotArea.YAxis.Appearance.Color = Global.System.Drawing.Color.FromArgb((CInt(Fix((CByte(225))))), (CInt(Fix((CByte(217))))), (CInt(Fix((CByte(201))))))
			Me.radChart1.PlotArea.YAxis.Appearance.LabelAppearance.Corners = corners18
			Me.radChart1.PlotArea.YAxis.Appearance.MajorGridLines.Color = Global.System.Drawing.Color.FromArgb((CInt(Fix((CByte(225))))), (CInt(Fix((CByte(217))))), (CInt(Fix((CByte(201))))))
			Me.radChart1.PlotArea.YAxis.Appearance.MajorGridLines.PenStyle = Global.System.Drawing.Drawing2D.DashStyle.Solid
			Me.radChart1.PlotArea.YAxis.Appearance.MajorTick.Color = Global.System.Drawing.Color.FromArgb((CInt(Fix((CByte(225))))), (CInt(Fix((CByte(217))))), (CInt(Fix((CByte(201))))))
			Me.radChart1.PlotArea.YAxis.Appearance.MinorGridLines.Color = Global.System.Drawing.Color.FromArgb((CInt(Fix((CByte(225))))), (CInt(Fix((CByte(217))))), (CInt(Fix((CByte(201))))))
			Me.radChart1.PlotArea.YAxis.Appearance.MinorGridLines.Visible = False
			Me.radChart1.PlotArea.YAxis.Appearance.MinorTick.Color = Global.System.Drawing.Color.FromArgb((CInt(Fix((CByte(225))))), (CInt(Fix((CByte(217))))), (CInt(Fix((CByte(201))))))
			...
			Me.radChart1.PlotArea.YAxis.Appearance.TextAppearance.TextProperties.Color = Global.System.Drawing.Color.FromArgb((CInt(Fix((CByte(112))))), (CInt(Fix((CByte(93))))), (CInt(Fix((CByte(56))))))
			...
			chartSeries1.Appearance.Border.Color = Global.System.Drawing.Color.FromArgb((CInt(Fix((CByte(223))))), (CInt(Fix((CByte(170))))), (CInt(Fix((CByte(43))))))
			...
			chartSeries1.Appearance.TextAppearance.TextProperties.Color = Global.System.Drawing.Color.FromArgb((CInt(Fix((CByte(151))))), (CInt(Fix((CByte(137))))), (CInt(Fix((CByte(110))))))
			...
			chartSeries2.Appearance.Border.Color = Global.System.Drawing.Color.FromArgb((CInt(Fix((CByte(223))))), (CInt(Fix((CByte(170))))), (CInt(Fix((CByte(43))))))
			...
			chartSeries2.Appearance.TextAppearance.TextProperties.Color = Global.System.Drawing.Color.FromArgb((CInt(Fix((CByte(151))))), (CInt(Fix((CByte(137))))), (CInt(Fix((CByte(110))))))
