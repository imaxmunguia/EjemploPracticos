...
Namespace Telerik.Examples.WinControls.GridView.FirstLook
	...
	Partial Public Class Form1
        ...
        Private buttonFont As New Font("Segoe UI", 9.0F, FontStyle.Bold)
		...
		Private Sub Form1_Load(ByVal sender As Object, ByVal e As EventArgs) Handles MyBase.Load
			...
			CType(Me.radTitleBar1.TitleBarElement.Children(2).Children(1), TextPrimitive).Text = String.Empty
