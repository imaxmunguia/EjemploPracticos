...
Namespace Telerik.Examples.WinControls.Chart.MarkedZones
	Partial Public Class Form1
		...
		Private Sub InitializeComponent()
			...
			' radChart1
			' 
			Me.radChart1.Appearance.Border.Color = System.Drawing.Color.FromArgb((CInt(Fix((CByte(202))))), (CInt(Fix((CByte(201))))), (CInt(Fix((CByte(180))))))
			...
			Me.radChart1.Appearance.FillStyle.MainColor = System.Drawing.Color.FromArgb((CInt(Fix((CByte(239))))), (CInt(Fix((CByte(236))))), (CInt(Fix((CByte(220))))))
			Me.radChart1.Appearance.FillStyle.SecondColor = System.Drawing.Color.FromArgb((CInt(Fix((CByte(225))))), (CInt(Fix((CByte(224))))), (CInt(Fix((CByte(214))))))
			...
			Me.radChart1.ChartTitle.TextBlock.Appearance.TextProperties.Color = System.Drawing.Color.FromArgb((CInt(Fix((CByte(96))))), (CInt(Fix((CByte(96))))), (CInt(Fix((CByte(78))))))
			Me.radChart1.ChartTitle.TextBlock.Appearance.TextProperties.Font = New System.Drawing.Font("Arial", 21.75F)
			Me.radChart1.ChartTitle.TextBlock.Text = "Marked Zones"
			Me.radChart1.DataGroupColumn = Nothing
			Me.radChart1.Legend.Appearance.Border.Color = System.Drawing.Color.FromArgb((CInt(Fix((CByte(160))))), (CInt(Fix((CByte(154))))), (CInt(Fix((CByte(130))))))
			Me.radChart1.Legend.Appearance.Corners = corners5
			Me.radChart1.Legend.Appearance.FillStyle.MainColor = System.Drawing.Color.FromArgb((CInt(Fix((CByte(254))))), (CInt(Fix((CByte(253))))), (CInt(Fix((CByte(246))))))
			...
			Me.radChart1.PlotArea.Appearance.Border.Color = System.Drawing.Color.FromArgb((CInt(Fix((CByte(160))))), (CInt(Fix((CByte(154))))), (CInt(Fix((CByte(130))))))
			...
			Me.radChart1.PlotArea.Appearance.FillStyle.MainColor = System.Drawing.Color.FromArgb((CInt(Fix((CByte(254))))), (CInt(Fix((CByte(253))))), (CInt(Fix((CByte(246))))))
			Me.radChart1.SkinsOverrideStyles = True
			Me.radChart1.Skin = "Apple"
			Me.radChart1.PlotArea.XAxis.Appearance.Color = System.Drawing.Color.FromArgb((CInt(Fix((CByte(160))))), (CInt(Fix((CByte(154))))), (CInt(Fix((CByte(130))))))
			Me.radChart1.PlotArea.XAxis.Appearance.LabelAppearance.Corners = corners13
			Me.radChart1.PlotArea.XAxis.Appearance.MajorGridLines.Color = System.Drawing.Color.FromArgb((CInt(Fix((CByte(234))))), (CInt(Fix((CByte(232))))), (CInt(Fix((CByte(220))))))
			...
			Me.radChart1.PlotArea.YAxis.Appearance.Color = System.Drawing.Color.FromArgb((CInt(Fix((CByte(160))))), (CInt(Fix((CByte(154))))), (CInt(Fix((CByte(130))))))
			Me.radChart1.PlotArea.YAxis.Appearance.LabelAppearance.Corners = corners18
			Me.radChart1.PlotArea.YAxis.Appearance.MajorGridLines.Color = System.Drawing.Color.FromArgb((CInt(Fix((CByte(234))))), (CInt(Fix((CByte(232))))), (CInt(Fix((CByte(220))))))
			...
			chartSeries1.Appearance.Border.Color = System.Drawing.Color.FromArgb((CInt(Fix((CByte(187))))), (CInt(Fix((CByte(149))))), (CInt(Fix((CByte(58))))))
			...
			chartSeries2.Appearance.Border.Color = System.Drawing.Color.FromArgb((CInt(Fix((CByte(187))))), (CInt(Fix((CByte(149))))), (CInt(Fix((CByte(58))))))
