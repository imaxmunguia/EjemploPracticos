...
'			Me.radRibbonBarChunk2.Click += New System.EventHandler(Me.radRibbonBarChunk2_Click);
			' 
			' radButtonElement5
			' 
			...
			Me.radButtonElement5.Margin = New System.Windows.Forms.Padding(4, 0, 4, 0)
...
'			Me.radButtonElement5.Click += New System.EventHandler(Me.radButtonElement5_Click);
			' 
			' radButtonElement29
			' 
			...
			Me.radButtonElement29.TextAlignment = System.Drawing.ContentAlignment.MiddleLeft
			Me.radButtonElement29.TextImageRelation = System.Windows.Forms.TextImageRelation.ImageBeforeText
'			Me.radButtonElement29.Click += New System.EventHandler(Me.radButtonElement29_Click);
			' 
			' radRibbonBarGroup1
			' 
			...
			Me.radButtonElement1.Padding = New System.Windows.Forms.Padding(2)
			Me.radButtonElement1.StretchVertically = False
            Me.radButtonElement1.Text = "Office 2010 Blue"
			Me.radButtonElement1.TextAlignment = System.Drawing.ContentAlignment.MiddleLeft
...
'			Me.radButtonElement1.Click += New System.EventHandler(Me.radButtonElement1_Click);
			...
			Me.radButtonElement2.Padding = New System.Windows.Forms.Padding(2)
...
'			Me.radButtonElement2.Click += New System.EventHandler(Me.radButtonElement2_Click);
			' 
			' radButtonElement3
			' 
			...
			Me.radButtonElement3.Padding = New System.Windows.Forms.Padding(2)
...
'			Me.radButtonElement3.Click += New System.EventHandler(Me.radButtonElement3_Click);
			' 
			...
			Me.radRibbonBar1.Size = New System.Drawing.Size(942, 144)
			...
			Me.radButtonElement41.ZIndex = 2
			' 
			' radButtonElement42
			' 
			...
			Me.radButtonElement42.ZIndex = 1
			' 
			' radMenuItem1
			' 
			...
			Me.BackColor = System.Drawing.Color.FromArgb((CInt(Fix((CByte(217))))), (CInt(Fix((CByte(224))))), (CInt(Fix((CByte(237))))))
			Me.ClientSize = New System.Drawing.Size(942, 667)
...
'			Me.Load += New System.EventHandler(Me.Form1_Load);
		...
		Private WithEvents radRibbonBarChunk2 As RadRibbonBarGroup
		...
		Private WithEvents radButtonElement29 As RadButtonElement
		Private WithEvents radButtonElement5 As RadButtonElement
		...
		Private WithEvents radButtonElement1 As RadButtonElement
		Private WithEvents radButtonElement2 As RadButtonElement
        Private WithEvents radButtonElement3 As RadButtonElement
