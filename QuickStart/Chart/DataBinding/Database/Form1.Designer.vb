...
Namespace Telerik.Examples.WinControls.Chart.DataBinding.Database
	Partial Public Class Form1
		...
		Private Sub InitializeComponent()
			...
			' 
			Me.radChart1.Skin = "Default2006"
			Me.radChart1.Appearance.Border.Color = System.Drawing.Color.FromArgb((CInt(Fix((CByte(182))))), (CInt(Fix((CByte(224))))), (CInt(Fix((CByte(249))))))
			...
			Me.radChart1.Appearance.FillStyle.MainColor = System.Drawing.Color.FromArgb((CInt(Fix((CByte(240))))), (CInt(Fix((CByte(252))))), (CInt(Fix((CByte(255))))))
			...
			Me.radChart1.ChartTitle.TextBlock.Appearance.TextProperties.Color = System.Drawing.Color.FromArgb((CInt(Fix((CByte(70))))), (CInt(Fix((CByte(143))))), (CInt(Fix((CByte(190))))))
			Me.radChart1.ChartTitle.TextBlock.Text = "Database Binding"
			Me.radChart1.DataGroupColumn = Nothing
			Me.radChart1.DefaultType = Telerik.Charting.ChartSeriesType.Pie
			Me.radChart1.Legend.Appearance.Border.Color = System.Drawing.Color.FromArgb((CInt(Fix((CByte(208))))), (CInt(Fix((CByte(237))))), (CInt(Fix((CByte(255))))))
			...
			Me.radChart1.Legend.Appearance.ItemTextAppearance.TextProperties.Color = System.Drawing.Color.FromArgb((CInt(Fix((CByte(62))))), (CInt(Fix((CByte(117))))), (CInt(Fix((CByte(154))))))
			Me.radChart1.Legend.Marker.Appearance.Corners = corners9
			Me.radChart1.Legend.TextBlock.Appearance.Corners = corners10
			Me.radChart1.Location = New System.Drawing.Point(13, 16)
			Me.radChart1.Name = "radChart1"
			Me.radChart1.PlotArea.Appearance.Border.Color = System.Drawing.Color.FromArgb((CInt(Fix((CByte(149))))), (CInt(Fix((CByte(184))))), (CInt(Fix((CByte(206))))))
			...
			unit6.Value = 10F
			Me.radChart1.PlotArea.Appearance.Dimensions.Margins = New Telerik.Charting.Styles.ChartMargins(unit3, unit4, unit5, unit6)
			...
			Me.radChart1.PlotArea.XAxis.Appearance.Color = System.Drawing.Color.FromArgb((CInt(Fix((CByte(149))))), (CInt(Fix((CByte(184))))), (CInt(Fix((CByte(206))))))
			Me.radChart1.PlotArea.XAxis.Appearance.LabelAppearance.Corners = corners13
			Me.radChart1.PlotArea.XAxis.Appearance.MajorGridLines.Color = System.Drawing.Color.FromArgb((CInt(Fix((CByte(153))))), (CInt(Fix((CByte(187))))), (CInt(Fix((CByte(207))))))
			Me.radChart1.PlotArea.XAxis.Appearance.MajorTick.Color = System.Drawing.Color.FromArgb((CInt(Fix((CByte(149))))), (CInt(Fix((CByte(184))))), (CInt(Fix((CByte(206))))))
			Me.radChart1.PlotArea.XAxis.Appearance.TextAppearance.Corners = corners14
			Me.radChart1.PlotArea.XAxis.Appearance.TextAppearance.TextProperties.Color = System.Drawing.Color.FromArgb((CInt(Fix((CByte(62))))), (CInt(Fix((CByte(117))))), (CInt(Fix((CByte(154))))))
			...
			Me.radChart1.PlotArea.YAxis.Appearance.Color = System.Drawing.Color.FromArgb((CInt(Fix((CByte(149))))), (CInt(Fix((CByte(184))))), (CInt(Fix((CByte(206))))))
			Me.radChart1.PlotArea.YAxis.Appearance.LabelAppearance.Corners = corners18
			Me.radChart1.PlotArea.YAxis.Appearance.MajorGridLines.Color = System.Drawing.Color.FromArgb((CInt(Fix((CByte(153))))), (CInt(Fix((CByte(187))))), (CInt(Fix((CByte(207))))))
			Me.radChart1.PlotArea.YAxis.Appearance.MajorGridLines.PenStyle = System.Drawing.Drawing2D.DashStyle.Solid
			Me.radChart1.PlotArea.YAxis.Appearance.MajorTick.Color = System.Drawing.Color.FromArgb((CInt(Fix((CByte(149))))), (CInt(Fix((CByte(184))))), (CInt(Fix((CByte(206))))))
			Me.radChart1.PlotArea.YAxis.Appearance.MinorGridLines.Color = System.Drawing.Color.FromArgb((CInt(Fix((CByte(153))))), (CInt(Fix((CByte(187))))), (CInt(Fix((CByte(207))))))
			...
			Me.radChart1.PlotArea.YAxis.Appearance.TextAppearance.TextProperties.Color = System.Drawing.Color.FromArgb((CInt(Fix((CByte(62))))), (CInt(Fix((CByte(117))))), (CInt(Fix((CByte(154))))))
			...
			Me.radChart1.PlotArea.YAxis.MaxValue = 120
			...
			chartSeries1.Appearance.Border.Color = System.Drawing.Color.FromArgb((CInt(Fix((CByte(153))))), (CInt(Fix((CByte(209))))), (CInt(Fix((CByte(248))))))
			...
			chartSeries1.Appearance.TextAppearance.TextProperties.Color = System.Drawing.Color.FromArgb((CInt(Fix((CByte(72))))), (CInt(Fix((CByte(124))))), (CInt(Fix((CByte(160))))))
			chartSeries1.Name = "Series 1"
			chartSeries1.Type = Telerik.Charting.ChartSeriesType.CandleStick
			chartSeries2.Appearance.Border.Color = System.Drawing.Color.FromArgb((CInt(Fix((CByte(153))))), (CInt(Fix((CByte(209))))), (CInt(Fix((CByte(248))))))
			...
			chartSeries2.Appearance.TextAppearance.TextProperties.Color = System.Drawing.Color.FromArgb((CInt(Fix((CByte(72))))), (CInt(Fix((CByte(124))))), (CInt(Fix((CByte(160))))))
			chartSeries2.Name = "Series 2"
			chartSeries2.Type = Telerik.Charting.ChartSeriesType.CandleStick
			chartSeries3.Appearance.Border.Color = System.Drawing.Color.FromArgb((CInt(Fix((CByte(153))))), (CInt(Fix((CByte(209))))), (CInt(Fix((CByte(248))))))
			...
			chartSeries3.Appearance.TextAppearance.TextProperties.Color = System.Drawing.Color.FromArgb((CInt(Fix((CByte(72))))), (CInt(Fix((CByte(124))))), (CInt(Fix((CByte(160))))))
			...
			Me.radChart1.SkinsOverrideStyles = True
			Me.radChart1.Skin = "Apple"
			Me.radChart1.Size = New System.Drawing.Size(600, 500)
