...
Namespace Telerik.Examples.WinControls.TreeView.Customize.CustomNodes
	Partial Class Form1
		...
		Protected Overrides Function CalculateTreeWidth(ByVal clientWidth As Integer) As Integer
			Return Me.radTreeView1.Width
		End Function

		Protected Overrides Function CalculateOffset(ByVal clientWidth As Integer) As Integer
			Return (clientWidth - Me.radTreeView1.Width) / 2
		End Function
