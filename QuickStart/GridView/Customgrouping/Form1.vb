...
Namespace Telerik.Examples.WinControls.GridView.CustomGrouping
	Partial Public Class Form1
		...
		Private Sub radGridView1_CustomGrouping(ByVal sender As Object, ByVal e As GridViewCustomGroupingEventArgs) Handles radGridView.CustomGrouping
