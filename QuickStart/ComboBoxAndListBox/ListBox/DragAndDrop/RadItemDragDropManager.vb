...
Namespace Telerik.Examples.WinControls
	...
	Public Class RadItemDragDropManager
		...
		Private outlineForm As System.Windows.Forms.Form
		...
		Private Sub PrepareDragging(ByVal e As MouseEventArgs)
			If Me.draggedItem.VisualItem.Visibility = ElementVisibility.Visible Then
				...
				Me.outlineForm.FormBorderStyle = System.Windows.Forms.FormBorderStyle.None
	...
	Public Class FeedBackForm
		...
		Public Property EndPoint() As Nullable(Of Point)
			Get
				Return _endPoint
			End Get
			Set(ByVal value As Nullable(Of Point))
				_endPoint = value
			End Set
		End Property

		Public Property StartPoint() As Nullable(Of Point)
			Get
				Return _startPoint
			End Get
			Set(ByVal value As Nullable(Of Point))
		...
		Protected Overrides Sub OnPaint(ByVal e As PaintEventArgs)
			...
			pen.Width = 4
			g.DrawLine(pen, 0, 0, 285, 0)
			pen.Dispose()
			MyBase.OnPaint(e)
		End Sub
		Private _startPoint As Nullable(Of Point)
		Private _endPoint As Nullable(Of Point)
	End Class
End Namespace
