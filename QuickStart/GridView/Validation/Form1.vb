...
Namespace Telerik.Examples.WinControls.GridView.Validation
	Partial Public Class Form1
		...
		Private Sub radComboBox3_SelectedIndexChanged(ByVal sender As Object, ByVal e As Telerik.WinControls.UI.Data.PositionChangedEventArgs) Handles radComboBox3.SelectedIndexChanged
			Dim validationInfo As ColumnValidationInfo = CType(radComboBox1.SelectedValue, ColumnValidationInfo)
		...
		Private Sub radGridView1_CellEndEdit(ByVal sender As Object, ByVal e As GridViewCellEventArgs) Handles radGridView1.CellEndEdit
		...
		Public Class ColumnValidationInfo
			Public Shared validators As List(Of ICellValidator) = New List(Of ICellValidator)()
			...
			If row IsNot Nothing Then
				...
				For Each item As RadListDataItem In radComboBox1.Items
					...
					If (Not validationInfo.Validate(Convert.ToDecimal(value))) Then
						...
						validationMessage.Append(validationInfo.Column.HeaderText & " " & validationInfo.GetMessage(Convert.ToDecimal(value)) + Constants.vbLf)
					End If
					If radGridView1.IsInEditMode AndAlso radGridView1.CurrentRow Is row AndAlso radGridView1.CurrentColumn Is validationInfo.Column Then
						...
						If (Not validationInfo.Validate(Convert.ToDecimal(editorValue))) Then
							validationFailed = True
							validationMessage.Append(validationInfo.Column.HeaderText & " " & validationInfo.GetMessage(Convert.ToDecimal(editorValue)) + Constants.vbLf)
						End If
					End If
				Next item
