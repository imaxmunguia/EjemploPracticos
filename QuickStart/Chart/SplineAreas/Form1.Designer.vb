...
Namespace Telerik.Examples.WinControls.Chart.SplineAreas
	Partial Public Class Form1
		...
		Private Sub InitializeComponent()
			...
			Dim unit8 As New Global.Telerik.Charting.Styles.Unit()
			...
			unit3.Value = 10F
			unit4.Value = 10F
			Me.radChart1.ChartTitle.Appearance.Dimensions.Margins = New Global.Telerik.Charting.Styles.ChartMargins(unit1, unit2, unit3, unit4)
			...
			Me.radChart1.ChartTitle.TextBlock.Text = "Spline Areas"
			...
			unit7.Value = 10F
			unit8.Type = Global.Telerik.Charting.Styles.UnitType.Percentage
			unit8.Value = 10F
			Me.radChart1.PlotArea.Appearance.Dimensions.Margins = New Global.Telerik.Charting.Styles.ChartMargins(unit5, unit6, unit7, unit8)
