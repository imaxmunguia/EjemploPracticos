...
Namespace Telerik.Examples.WinControls.PageView.StripView.StripButtons
	...
	Partial Public Class Form1
		...
		Protected Overrides Sub OnLoad(ByVal e As EventArgs)
			...
			Me.radPageView1.ThemeName = "Office2010"
		...
		Private Sub PopulateDropDownLists()
			Dim buttons As List(Of StripViewButtons) = New List(Of StripViewButtons)()
		...
		Private Sub animatedScrollingCheck_ToggleStateChanged(ByVal sender As Object, ByVal args As StateChangedEventArgs) Handles animatedScrollingCheck.ToggleStateChanged
			Me.strip.AnimatedStripScrolling = Me.animatedScrollingCheck.Checked
		End Sub

		Private Sub stripButtonsCombo_SelectedIndexChanged(ByVal sender As Object, ByVal e As Telerik.WinControls.UI.Data.PositionChangedEventArgs) Handles stripButtonsCombo.SelectedIndexChanged
		...
		Private Sub selectedPageCombo_SelectedIndexChanged(ByVal sender As Object, ByVal e As Telerik.WinControls.UI.Data.PositionChangedEventArgs) Handles selectedPageCombo.SelectedIndexChanged
