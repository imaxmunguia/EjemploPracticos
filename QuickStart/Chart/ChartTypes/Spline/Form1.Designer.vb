...
Namespace Telerik.Examples.WinControls.Chart.ChartTypes.Spline
	Partial Public Class Form1
		...
		Private Sub InitializeComponent()
			...
			Me.radChart1.DefaultType = Telerik.Charting.ChartSeriesType.Spline
			...
			Me.radChart1.PlotArea.XAxis.AxisLabel.TextBlock.Text = "Month"
			...
			Me.radChart1.PlotArea.YAxis.AxisLabel.TextBlock.Text = "Sales"
