...
Namespace Telerik.Examples.WinControls.GridView.CustomViews
	Public Class GridViewDetailElement
		...
		Protected Overrides Sub CreateChildElements()
			...
			Me.groupBoxElement.Content.Padding = New System.Windows.Forms.Padding(20)
			...
			Me.groupBoxStackLayoutFirstColumn.Orientation = System.Windows.Forms.Orientation.Vertical
