...
Namespace Telerik.Examples.WinControls.RadScheduler.Printing
    Partial Public Class Form1
        ...
        Private Sub radScheduler1_ActiveViewChanged(sender As Object, e As Telerik.WinControls.UI.SchedulerViewChangedEventArgs) Handles radScheduler1.ActiveViewChanged
        ...
        Private Sub radio_ToggleStateChanged(sender As Object, args As StateChangedEventArgs) Handles radioDaily.ToggleStateChanged, radioWeekly.ToggleStateChanged, radioMonthly.ToggleStateChanged, radioDetails.ToggleStateChanged
            ...
            ElseIf sender Is Me.radioWeekly Then
                Me.radScheduler1.ActiveViewType = SchedulerViewType.Week
                Dim startDate As DateTime = DateHelper.GetStartOfWeek(Me.radScheduler1.ActiveView.EndDate, Me.radScheduler1.DateTimeFormat, DayOfWeek.Monday)
                Dim endDate As DateTime = DateHelper.GetEndOfWeek(startDate, Me.radScheduler1.DateTimeFormat, DayOfWeek.Monday).AddDays(-1)
        ...
        Private Sub FillAppointments()
            ...
            Dim dtStart As DateTime = DateHelper.GetStartOfWeek(DateTime.Today, System.Globalization.CultureInfo.CurrentCulture.DateTimeFormat).AddHours(10)
            Dim dtEnd As DateTime = DateHelper.GetStartOfWeek(DateTime.Today, System.Globalization.CultureInfo.CurrentCulture.DateTimeFormat).AddHours(12)
