...
namespace Telerik.Examples.WinControls.GridView.UnboundMode
{
    public partial class Form1 : ExamplesForm
    {
        ...
        public Form1()
        {
            ...
            Bitmap bmp = new Bitmap(Resources.Chart_Bar);
            bmp.MakeTransparent(Color.Magenta);
            bitmaps.Add(bmp);

            bmp = new Bitmap(Resources.Chart_Gantt);
            bmp.MakeTransparent(Color.Magenta);
            bitmaps.Add(bmp);

            bmp = new Bitmap(Resources.Chart_Pie);
            bmp.MakeTransparent(Color.Magenta);
            bitmaps.Add(bmp);

            bmp = new Bitmap(Resources.Chart_Dot);
            bmp.MakeTransparent(Color.Magenta);
            bitmaps.Add(bmp);
        ...
        {
            AppendNewColumn(this.radComboBox1.SelectedItem.Text, true);
            this.LoadColumnsComboBox();
        } 
