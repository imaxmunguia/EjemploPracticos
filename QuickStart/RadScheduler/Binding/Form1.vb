...
Namespace Telerik.Examples.WinControls.RadScheduler.Binding
	Partial Public Class Form1
		...
		Protected Overrides Sub OnLoad(ByVal e As EventArgs)
			...
			Me.radSchedulerDemo.ActiveView.StartDate = New DateTime(2009, 3, 7)
		...
		Private Sub BindToBusinessObjects()
			...
			Dim baseDate As New DateTime(2009, 3, 7)
		...
		Private Sub btnSave_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnSave.Click
			...
			Catch ex As Exception
				MessageBox.Show(String.Format("An error occurred during the update process:" & Constants.vbLf & "{0}", ex.Message))
			Finally
				If deletedChildRecords IsNot Nothing Then
