...
Namespace Telerik.Examples.WinControls.SplitContainer.FirstLook
	Partial Public Class LayoutProperties
		...
		Private Sub InitializeComponent()
			...
			' radTreeView1
			' 
			Me.radTreeView1.BackColor = System.Drawing.Color.FromArgb((CInt(Fix((CByte(191))))), (CInt(Fix((CByte(219))))), (CInt(Fix((CByte(255))))))
			...
			' checkCollapsed
			' 
			Me.checkCollapsed.ForeColor = System.Drawing.Color.FromArgb((CInt(Fix((CByte(5))))), (CInt(Fix((CByte(5))))), (CInt(Fix((CByte(5))))))
			Me.checkCollapsed.Location = New System.Drawing.Point(11, 38)
			Me.checkCollapsed.Name = "checkCollapsed"
			' 
			' 
			' 
			Me.checkCollapsed.RootElement.ForeColor = System.Drawing.Color.FromArgb((CInt(Fix((CByte(5))))), (CInt(Fix((CByte(5))))), (CInt(Fix((CByte(5))))))
			...
			' checkFixed
			' 
			Me.checkFixed.ForeColor = System.Drawing.Color.FromArgb((CInt(Fix((CByte(5))))), (CInt(Fix((CByte(5))))), (CInt(Fix((CByte(5))))))
			Me.checkFixed.Location = New System.Drawing.Point(11, 13)
			Me.checkFixed.Name = "checkFixed"
			' 
			' 
			' 
			Me.checkFixed.RootElement.ForeColor = System.Drawing.Color.FromArgb((CInt(Fix((CByte(5))))), (CInt(Fix((CByte(5))))), (CInt(Fix((CByte(5))))))
			...
			' checkSplitterFixed
			' 
			Me.checkSplitterFixed.ForeColor = System.Drawing.Color.FromArgb((CInt(Fix((CByte(5))))), (CInt(Fix((CByte(5))))), (CInt(Fix((CByte(5))))))
			Me.checkSplitterFixed.Location = New System.Drawing.Point(11, 13)
			Me.checkSplitterFixed.Name = "checkSplitterFixed"
			' 
			' 
			' 
			Me.checkSplitterFixed.RootElement.ForeColor = System.Drawing.Color.FromArgb((CInt(Fix((CByte(5))))), (CInt(Fix((CByte(5))))), (CInt(Fix((CByte(5))))))
